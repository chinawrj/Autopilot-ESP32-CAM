...
- **所有终端命令通过 tmux 执行** — 使用 `.github/skills/tmux-multi-shell/SKILL.md` 中的 sentinel 模式
- **每次代码变更必须上板测试** — build → flash → monitor → 验证，参见 `.github/skills/automated-testing/SKILL.md`
...
2. 配置文件: `~/.esp-wifi-credentials`（格式见 .github/skills/wifi-credentials/）
